...
var gameScene = cc.Scene.extend({
    onEnter: function() {
        ...
        var label = cc.LabelTTF.create("Stage " + stage , "けいふぉんと", 26);
        label.setPosition(size.width / 6, size.height / 1.1);
        this.addChild(label, 1);
        jumpText = cc.LabelTTF.create("Jumps:" + f, "けいふぉんと", "24", cc.TEXT_ALIGNMENT_CENTER);
        this.addChild(jumpText, 1);
        jumpText.setPosition(size.width / 2, size.height / 1.1);

        bonusText = cc.LabelTTF.create("Bonus:" + t, "けいふぉんと", "24", cc.TEXT_ALIGNMENT_CENTER);
        this.addChild(bonusText, 1);
        bonusText.setPosition(size.width / 1.3, size.height / 1.1);
    ...
    onTouchEnded: function(touch, event) {
        ...
        if (touchflag == true) {
            ...
            f = f - 1;
            jumpText.setString("Jumps:" + f);
        }

        if (f == -1) {
            jumpText.setString("Jumps:" + 0);
...
var game = cc.Layer.extend({
    init: function() {
        ...
        this.addBody(250, 10, 100, 20, false, res.ground4_png, SpriteTag.ground);
        this.addBody(250, 37, 40, 36, false, res.hata_png, SpriteTag.hata);
        ...
        this.addBody(250, 250, 41, 38, true, res.totem_png, SpriteTag.totem);
...
var MemoryTile6 = cc.Sprite.extend({
    ctor: function() {
        this._super();
        this.initWithFile(res.tugi3_png);
        cc.eventManager.addListener(listener6.clone(), this);
    }
});
...
var listener6 = cc.EventListener.create({
    event: cc.EventListener.TOUCH_ONE_BY_ONE,
    swallowTouches: true,
    onTouchBegan: function(touch, event) {
